...
urlpatterns = [
    ...
    path('category-product_list/<int:cat_id>',
         views.category_product_list, name='category-product_list'),
    path('brand-product_list/<int:brand_id>',
         views.brand_product_list, name='brand-product_list'),
